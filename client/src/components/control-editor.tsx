...
import { Trash2, Plus, Eye, Move, Palette, Settings, MousePointer } from 'lucide-react';
...
export function ControlEditor({ controls, onControlsChange, onSave, isSaving }: ControlEditorProps) {
  ...
  }, [draggedControl, dragOffset, updateControl]);
      ...
      <div className="lg:col-span-2">
        <Card className="h-full">
          ...
          <CardContent className="p-0">
            <div 
              ref={canvasRef}
              className="relative w-full h-[480px] bg-gray-50 border-2 border-dashed border-gray-200 overflow-hidden"
